...
function mapAxesToCapabilities(axes) {
    ...
    const capabilities = {
        ...
        content_delivery: resolveCapability(axes.static_content), // CDN typically when static content is required
        ...
        sensitive_data: resolveCapability(axes.data_sensitivity), // may be enum; handled in resolveCapability
