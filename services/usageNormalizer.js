...
const CANONICAL_SERVICES = require('./canonicalServiceRegistry').CANONICAL_SERVICES;
            ...
            case 'AWS':
                usage['aws_cloudfront_distribution.cdn'] = {
                    monthly_data_transfer_to_internet_gb: {
                        us: transferGB * 0.5,
                        europe: transferGB * 0.3,
                        asia: transferGB * 0.2
                    },
                    monthly_http_requests: monthlyRequests * 0.8, // 80% cached
                    monthly_https_requests: monthlyRequests * 0.2
                };
                break;
