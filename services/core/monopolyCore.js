...
const classifyWorkload = (intentTags) => {
    ...
    // 🔥 PRIORITY 1: ML/AI workloads (must check BEFORE gaming/streaming)
    if (intentTags.includes("ai") || intentTags.includes("ml") ||
        intentTags.includes("machine_learning") || intentTags.includes("artificial_intelligence") ||
        intentTags.includes("llm") || intentTags.includes("gpt") || intentTags.includes("chatbot") ||
        intentTags.includes("content_generation") || intentTags.includes("ai_assistant") ||
        intentTags.includes("inference") || intentTags.includes("model_serving")) {
        return "ml_intensive";
    }
